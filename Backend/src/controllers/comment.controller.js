...
const createComment = async (req, res, next) => {
   try {
      ...
      let post, user, createdComment, err;
...
const likeComment = async (req, res, next) => {
   try {
      ...
      commentObject.isLiked =
         ...
         updatedComment.likes.some((like) => like.equals(userId));
      commentObject.likeCount = Array.isArray(updatedComment.likes) && updatedComment.likes.length;
      commentObject.replyCount =
         Array.isArray(updatedComment.replies) && updatedComment.replies.length;
      delete commentObject.likes;
      delete commentObject.replies;
...
const unlikeComment = async (req, res, next) => {
   try {
      ...
      commentObject.isLiked =
         Array.isArray(updatedComment.likes) &&
         updatedComment.likes.some((like) => like.equals(userId));
      commentObject.likeCount = Array.isArray(updatedComment.likes)
         ? updatedComment.likes.length
         : 0;
      commentObject.replyCount = Array.isArray(updatedComment.replies)
