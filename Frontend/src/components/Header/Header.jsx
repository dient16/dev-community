...
const { IoIosAddCircleOutline, FaRegBell, FaBell, MdMenu, SlClose } = icons;
         ...
         <div className="header__inner">
            ...
            {isLoggedIn ? (
               ...
               <div className="header__actions">
                  <Button outline to={`/${path.REGISTER}`} className="btn-actions-register">
                     Sign up
                  </Button>
                  <BtnAnt
                     className="btn-search"
                  ...
                  />
                  <Button primary to={`/${path.LOGIN}`} className="btn-actions-login">
                     Sign in
                  </Button>
               </div>
            )}
