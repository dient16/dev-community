...
const NewPost = () => {
   ...
   const items = [
      {
         key: '1',
         label: <h2 className="tab-create">Edit</h2>,
         children: (
            <div>
               ...
               <div className="new-post__bottom">
                  ...
                  <Button
                     className="new-post__btn-create-post"
                     size="large"
      ...
      {
         key: '2',
         label: <h2 className="tab-create">Preview</h2>,
         children: (
            <PreviewPost
               body={postBody}
               title={postTitle}
   ...
   return (
      <>
         <Spin
            size="large"
            spinning={createPostMutation.isPending}
            fullscreen={createPostMutation.isPending}
         ></Spin>
