            ...
            <form onSubmit={handleSubmit(handleEditPost)}>
                <div className="edit-post">
                    <div className="edit-post__wrapper">
                        <div className="edit-post__add-image">
                            <Controller
                                control={control}
                                name="image"
                        ...
                        <div className="edit-post__bottom">
                            <div className="edit-post__markdown">
                                <Controller
                                    control={control}
                                    name="body"
                                    rules={{
                            ...
                            <Button className="edit-post__btn-edit-post" type="primary" size="large" htmlType="submit">
                                Save change
                            </Button>
                        </div>
                    </div>
