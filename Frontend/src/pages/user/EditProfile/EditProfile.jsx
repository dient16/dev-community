...
function EditProfile() {
   ...
   return (
      <>
         <Spin
            size="large"
            spinning={mutationEditProfile.isPending || isLoading}
            fullscreen={true}
         />
               ...
               <div className="settings-form">
                  ...
                  <div className="setting-fields">
                     ...
                     <div className="avatar-field">
                        <span>
                           <Avatar
                              src={!previewAvatar ? getValues('avatar') : previewAvatar}
                              size={40}
                           />
                        </span>
                        <Input
                     ...
                     <Controller
                        ...
                        render={({ field }) => (
                           <>
                              ...
                              {errors.links && (
                                 <span className="error-message">{errors.links.message}</span>
                              )}
                           </>
                        )}
                     />
                     ...
                     <Controller
                        ...
                        render={({ field }) => (
                           <>
                              ...
                              {errors.work && (
                                 <span className="error-message">{errors.work.message}</span>
                              )}
                           </>
                        )}
                     />
